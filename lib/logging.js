...
var makelogfuncs = exports.makelogfuncs = function(target) {
  console.log(__dirname + ':: makelogfuncs function');

  function makelogger(level) {
    console.log(__dirname + ':: makelogger function, inside makelogfuncs function');
    return function() {
      var args = common.arrayify(arguments)
      args.unshift(level)
...
var makelog = exports.makelog = function( logspec, ctxt ) {
  console.log(__dirname + ':: exports.makelog function');
  ...
  var log = function(level,type) {
    console.log(__dirname + ':: log function');
...
function parse_command_line( spec, logspec, flags ) {
  console.log(__dirname + ':: exports.parse_command_line function');
  flags = flags || {}
...
{
  console.log(__dirname + ':: exports.log_act_in function');
...
{
  console.log(__dirname + ':: exports.log_act_out function');
  if( actmeta.sub ) return;
...
{
  console.log(__dirname + ':: exports.log_act_err function');
...
exports.log_act_cache = function( instance, actinfo, actmeta,
                                  args, prior_ctxt, act_callpoint )
{
  console.log(__dirname + ':: exports.log_act_cache function');
  instance.log.debug(
    'act',
    minlen(actmeta.plugin_fullname || '-'),
    //actmeta.plugin_tag,
...
exports.log_exec_err = function( instance, err ) {
    console.log(__dirname + ':: exports.log_exec_err function');
  if( false === err.log ) return;
