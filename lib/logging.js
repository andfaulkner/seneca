...
console.log("IN SENECA MODULE FILE logging.js!");
...
var makelogfuncs = exports.makelogfuncs = function(target) {
  console.log('SENECA: in [seneca]/lib/logging.js:::: makelogfuncs function');

  function makelogger(level) {
    console.log('SENECA: in [seneca]/lib/logging.js:::: makelogger function, in makelogfuncs fn');
    return function() {
      var args = common.arrayify(arguments)
      args.unshift(level)
...
var makelog = exports.makelog = function( logspec, ctxt ) {
  console.log('SENECA: in [seneca]/lib/logging.js:::: exports.makelog function');
  ...
  var log = function(level,type) {
    console.log('SENECA: in [seneca]/lib/logging.js:::: log function');
  ...
  //TODO This is a likely potential spot for fixing the Seneca log output
...
function parse_command_line( spec, logspec, flags ) {
  console.log('SENECA: in [seneca]/lib/logging.js:::: exports.parse_command_line function');
  flags = flags || {}
...
{
  console.log('SENECA: in [seneca]/lib/logging.js:::: exports.log_act_in function');
...
{
  console.log('SENECA: in [seneca]/lib/logging.js:::: exports.log_act_out function');
  if( actmeta.sub ) return;
...
{
  console.log('SENECA: in [seneca]/lib/logging.js:::: exports.log_act_err function');
...
exports.log_act_cache = function( instance, actinfo, actmeta,
                                  args, prior_ctxt, act_callpoint )
{
  console.log('SENECA: in [seneca]/lib/logging.js:::: exports.log_act_cache function');
  instance.log.debug(
    'act',
    minlen(actmeta.plugin_fullname || '-'),
    //actmeta.plugin_tag,
...
exports.log_exec_err = function( instance, err ) {
    console.log('SENECA: in [seneca]/lib/logging.js:::: exports.log_exec_err function');
  if( false === err.log ) return;
